...
async function page ({searchParams}: Props) {
  ...
  return <div><AdminDashboard myPicks={myPicks} myPicksError={myPicksError} featuredPost={featuredPost} featuredPostError={featuredPostError} categories= {categories} categoriesError={categoriesError}/></div>;
};
